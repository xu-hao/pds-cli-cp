...
```
python cli.py <file containing your spec> --libraryPath <sub dir containing custom python functions> --nthreads <number of threads> --level <level> <a yaml file containing resource types> <a yaml file contains pids> <timestamp> --pdsHost <pds plugin host> --pdsPort <pds plugin port> --configDir <mapper config dir>
```
